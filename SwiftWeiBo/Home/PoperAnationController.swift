...
// PoperAnimationController继承了HomeTableViewController
class PoperAnimationController : NSObject,UIViewControllerTransitioningDelegate,UIViewControllerAnimatedTransitioning{
    ...
    func presentationControllerForPresentedViewController(presented: UIViewController, presentingViewController presenting: UIViewController, sourceViewController source: UIViewController) -> UIPresentationController?{
        ...
        let poperVC = PopPresentationController(presentedViewController: presented, presentingViewController: presenting)
        
        poperVC.poperframe = poperFrame
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning){
        ...
        NSNotificationCenter.defaultCenter().postNotificationName(kMenuViewShowORhidden, object: nil)
